...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 40.-- 20.
-- IMU is ok
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 10.-- 20.
...
-- more faster global optimization
-- POSE_GRAPH.global_sampling_ratio = 0.003
-- POSE_GRAPH.global_constraint_search_after_n_seconds = 10.


-- overlapped submaps trimmer
